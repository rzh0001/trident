...
import org.zlwl.trident.abi.datatypes.Fixed;
...
import static org.zlwl.trident.abi.Utils.typeMap;
...
public class UtilsTest {
    ...
    public void testTypeMapEmpty() {
        Assertions.assertEquals(Utils.typeMap(new ArrayList<>(), Uint256.class), (new ArrayList<Uint256>()));
    }
}
